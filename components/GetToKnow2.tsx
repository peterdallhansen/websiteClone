...
export default function GetToKnow3() {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto px-4 py-40">
          ...
          <div key={index} className="space-y-3 flex flex-col">
            ...
            >
              ...
              <div
                ...
                className="h-[300px] w-full rounded-2xl border bg-[#F8F9FA] flex items-center justify-center group hover:bg-gray-50 transition-colors duration-300"
              >
                {!offering.image && (
                  <offering.icon
