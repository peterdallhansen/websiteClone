        ...
        {isMobile ? (
          <Sheet>
            ...
            >
              ...
              {/* Navigation Links */}
              <nav className="flex flex-col items-start space-y-2 text-lg font-medium w-full">
                {links.map((link) => (
                  <div key={link.label} className="w-full">
                    ...
                    <div
                      ...
                      className={`mt-2 pl-4  ${
                        expandedMenu === link.label
                          ? "max-h-96 transition-max-height duration-300 ease-in"
                    ...
                    >
                      {link.sublinks.map((sublink) => (
                        <Link
                          ...
                          onClick={() => setExpandedMenu(null)} // Close menu on link click
                        >
                          {sublink.label}
                        </Link>
                      ))}
