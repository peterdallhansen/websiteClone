...
function News() {
  return (
    <div className="w-full max-w-screen xl:max-w-[2000px] grid md:grid-cols-2 gap-4 py-20 mb-40 min-h-[800px] mt-20 px-8">
      {/* Testimonial Card */}
      <Card className="relative overflow-hidden border-zinc-800 p-8 flex flex-col justify-between backdrop-blur-sm h-full group">
      ...
      <div className="w-full grid md:grid-rows-2 gap-4 h-full">
        <Card className="relative overflow-hidden border-zinc-800 backdrop-blur-sm w-full h-full p-8 group">
