  ...
  return (
    <div className="w-full max-w-screen xl:max-w-[2000px] grid md:grid-cols-2 gap-4 py-20 mb-40 min-h-[800px] mt-20 px-8">
      ...
      <BlurFade delay={0.25} inView>
        <Card className="relative overflow-hidden  p-8 flex flex-col justify-between backdrop-blur-sm h-full group cursor-pointer">
          ...
          <div className="relative z-10 space-y-2">
            ...
            <p className="text-white/90 text-2xl md:text-3xl font-medium leading-relaxed">
              Beyond the Numbers: Prototyping AI for Smarter Business
              Intelligence
            </p>
          </div>
      ...
      <div className="w-full grid md:grid-rows-2 gap-4 h-full">
        <BlurFade delay={0.35} inView>
          <Card className="relative overflow-hidden  backdrop-blur-sm w-full h-full p-8 group cursor-pointer">
