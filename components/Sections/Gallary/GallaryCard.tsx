...
export function GallaryCard({
  ...
  return (
    <a
      href="/"
      className={cn(
        "relative flex flex-col items-center justify-center w-[300px] md:w-[500px] h-[400px] rounded-2xl p-6 cursor-",
    ...
    >
      {/* Label */}
      <span className="absolute top-4 left-4 text-sm font-medium text-white/90">
        {label}
      </span>
